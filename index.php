...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li style="width:300px;left:-100px;top:10px;"><input type="text" class="form-control" id="search" name=""></li>
				<li style="top:10px;left:-100px;"><button class="btn btn-primary" id="search_btn" name=""><span class='glyphicon glyphicon-search'></span></button></li>
			</ul>

			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart' style="top:0px;left0px;"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Cart <span class="badge">0</span>	</a>
					...
					<div style="width: 300px;">
						<div class="panel panel-primary">
							...
							<div class="panel-heading">
								...
								<input type="submit" class="btn btn-success" style="bottom:12px; margin-left: 50px;" id="admin" value="Admin" name="admin">
    ...
    $("#admin").click(function(){
		...
		$.ajax({
			url: "adminlogin.php",
			method: "POST",
			data: {adminLogin:1,email:email, pwd:pwd},
